...
def get_local_seed(config_file):
    ...
    try:
        with open(config_file, 'r') as file_obj:
            ...
            if config_data and 'molobot' in config_data:
                if 'localseed' in config_data['molobot']:
                    local_seed = config_data['molobot']['localseed']
...
def save_local_seed(config_file, local_seed):
    ...
    try:
        with open(config_file, 'w') as wfile:
            config_data['molobot']['localseed'] = local_seed
